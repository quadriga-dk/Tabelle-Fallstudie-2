...
Falls Sie die SPARQL-Abfragen dann doch ausführen und probieren möchten, können Sie dies über einen SPARQL Query Editor bzw. SPARQL Client auf einer Website Ihrer Wahl in einem parallel geöffneten Browserfenster tun, z. B.:
...
🌨️ Cloud Mode: In diesem Modus können Sie die entsprechenden Jupyter Notebooks über Binder ausführen. Kapitel mit ausführbaren Notebooks sind durch ein Raketen-Symbol (🚀) gekennzeichnet - klicken Sie darauf, um das Notebook in Binder zu öffnen.  

💻 Local Mode: Das Herunterladen der Jupyter Notebooks auf Ihren Computer ermöglicht eine lokale Ausführung. Dadurch können Sie lokale Daten nutzen und umfassende Anpassungen vornehmen. Dies erfordert aber Kenntnisse einer entsprechenden Ausführungsumgebung (z.B. Anaconda).  
