...
Um dieses Wissen für Maschinen zugänglich zu machen, ist eine formale und gemeinsame Repräsentation erforderlich, die durch Ontologien ausgedrückt wird. Ontologien sind zu einem wichtigen Instrument geworden, ohne die die produktive Datenadministrierung und -implementierung unvorstellbar wären {cite}`gardner_ontologies_2005`. Diese Standards sorgen daher für eine interoperable Plattform, die solide und zukunftssicher ist. 
